...
import { RemoveFavoriteUseCase } from './remove-favorite.usecase';
...
describe('RemoveFavoriteUseCase', () => {
  it('should remove a favorite using the resolved indicator id', async () => {
    ...
    expect(favoriteRepository.remove).toHaveBeenCalledWith('user-1', 'ind-1');
  });
